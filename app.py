import os
# Force headless configurations before importing any ML frameworks
...
# Initialize MediaPipe safely for CPU workloads
...
def handle_frame(data):
    ...
    try:
        ...
        pass  # Prevent server thread crash on bad frames
